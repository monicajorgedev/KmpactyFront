    ...
    return (
        ...
        <form className={styles.companyform} onSubmit={handleSubmit}>
                ...
                <input type='password' name='password' value={inputs.password || ''} 
                        onChange={handleChange} placeholder='Introduce una contraseña. Mínimo 6 caracteres' required/>
                <input type='password' name='password_repeat' value={inputs.password_repeat || ''} 
