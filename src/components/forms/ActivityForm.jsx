...
const Activityform = ({ submit, data = {} }) => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "city") {
      ...
      setInputs((values) => ({
        ...values,
        location: { ...values.location, address: value },
      }));
    } else if (name === "active") {
    ...
    <>
      <form className={styles.activityform} onSubmit={handleSubmit}>
        <input
          ...
          placeholder="Nombre actividad o campamento"
          required
        />
        <select
          name="type"
        ...
        <input
          type="text"
          readOnly={"Provincia: Segovia"}
          placeholder="Provincia: Segovia"
        />
        <select
          name="city"
        ...
        <input
          ...
          onChange={handleChange}
          placeholder="Dirección donde se realiza la actividad"
          required
        />
        <select
          name="dates"
        ...
        <input
          ...
          value={inputs.price || ""}
          onChange={handleChange}
          placeholder='Precio. Ejemplo: 60€/semana ó poner "consultar precio"'
          required
        />
        <input
          type="text"
          ...
          onChange={handleChange}
          placeholder="Duración. Ejemplo: semanal o fechas"
          required
        />
        ...
        {!inputs.image ? (
          ...
          <p>
            ...
            <button onClick={() => setInputs({ ...inputs, image: null })}>
              Eliminar
            </button>
          </p>
        )}
